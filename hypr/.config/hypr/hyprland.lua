...
-- Make Electron-based dev tools (VS Code, Slack, Postman, Discord, ...) run
-- natively on Wayland instead of falling back to XWayland.
...
local mkdir_screenshots = "mkdir -p ~/Pictures/Screenshots"
hl.bind("PRINT", hl.dsp.exec_cmd(mkdir_screenshots .. " && grim ~/Pictures/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png"))
hl.bind(
	mainMod .. " + PRINT",
	hl.dsp.exec_cmd(
		mkdir_screenshots
